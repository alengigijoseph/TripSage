...
import com.example.hck.databinding.ActivitySearchBinding
import com.example.hck.presentation.ui.main.MainViewModel
...
class SearchActivity : AppCompatActivity() , SearchResultsAdapter.OnItemClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchRv = binding.searchResultsView
    ...
    override fun onBackPressed() {
        ...
        if (selectedPlace.isEmpty()){
            ...
            intent.putExtra("from", selectedPlace);
